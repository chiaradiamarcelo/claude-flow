...
withdrawals, ATM/branch channel specifics.
...
Scenario: Withdrawal rejected when amount exceeds balance
  Given an account ACC-002 with balance 30
  When the owner withdraws 50
...
- [ ] SCENARIO-02: Withdrawal rejected when amount exceeds balance
